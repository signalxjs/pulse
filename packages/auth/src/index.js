 ...
 * PAT fallback for dev, sessions in node:sqlite with tokens encrypted at
 * rest, signed HttpOnly cookies. Server-only, JSDoc-typed ESM (runs under
 * the no-transpiler `app/server.mjs`); types in `index.d.ts`.
 */
